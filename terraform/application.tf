...
#     	aws ecr get-login-password --region ${var.aws_region} | docker login --username ci-user --password-stdin ${data.aws_caller_identity.current.account_id}.dkr.ecr.${var.aws_region}.amazonaws.com
